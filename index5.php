...
<head>
    ...
    <!--<script type="module" src="dist/detailStopData/detailcenter.js"></script>-->
    <script type="module" src="dist/stationset5.js"></script>
...
<body>
    ...
    <form action="select.php" method="POST">
        ...
        <button type="button" onclick="location.href='./index11.php'">東武浅草駅へ移動</button>
...
');
    ...
    <script type="module" src="dist/Tforshow5.js"></script>
