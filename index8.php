...
<head>
  ...
  <script type="module" src="dist/detailStopData/Hodetailset.js"></script>
  <script type="module" src="dist/module/connectTable.js"></script>
  <script type="module" src="dist/stationset8.js"></script>
...
<body>
  ...
  <form action="select.php" method="POST">
    ...
    <button type="button" onclick="location.href='./index6_S.php?station=sendai'">新幹線仙台駅へ移動</button>
...
<script type="module" src="dist/detailStopData/Hodetailchange.js"></script>
<script type="module" src="dist/typeColor.js"></script>
<script type="module" src="dist/module/detailMainPut.js"></script>
<script type="module" src="dist/Tforshow8.js"></script>
