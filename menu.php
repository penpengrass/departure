    ...
    <div>土休日ダイヤ対応の駅は実際の土休日や祝日と表示ダイヤが連動している</div>
        ...
        <table class="menutable">
            ...
            <tr>
                ...
                <td class="long"><span class="orange">米原駅</span>, <span style="color:black;">天王寺駅</span>, <span class="orange">三ノ宮駅</span>, 
            ...
            <tr>
                ...
                <td><span style="color:black;">東京駅</span></td>
                <td><span style="color:black;">仙台駅</span>, <span style="color:blue;">高崎駅</span></td>
            </tr>
            <tr>
                <td>JR東海一般駅</td>
                <td><button type="button" onclick="location.href='./index7.php'">移動</button></td>
                <td><span class="orange">浜松駅</span></td>
                <td><span class="orange">沼津駅</span>, <span class="orange">静岡駅</span>, <span class="orange">豊橋駅</span>, 
