...
<body>
    ...
    <div>2026年(2025年)ダイヤの発車標をリアルタイムに再現</div>
    <div>土休日ダイヤ対応の駅は実際の土休日や祝日と表示ダイヤが連動している</div>
        ...
        <table class="menutable">
            <caption>表示駅</caption>
            <p class="chushaku">
                <span style="color:red;">赤字</span>は土休日ダイヤ対応，もしくは終日ダイヤ(2025年改正)<br>
                <span class="orange">橙字</span>は土休日ダイヤ対応，もしくは終日ダイヤ(2026年改正)<br>
                <span style="color:blue;">青字</span>は平日ダイヤのみ(2026年改正)<br>
                黒字は平日ダイヤのみ(2025年改正)<br>
            </p>
            <p class="chushaku"></p>
            <tr>
                <th>種類</th>
            ...
            <tr>
                ...
                <td><span style="color:black;">横浜駅</span>, <span style="color:red;">小田原駅</span>, <span style="color:red;">熱海駅</span>, 
                <span style="color:black;">大宮駅</span>, <span style="color:black;">宇都宮駅</span>, <span style="color:red;">黒磯駅</span></td>
            </tr>
            <tr>
                <td>JR東日本新幹線</td>
            ...
            <tr>
                ...
                <td><span style="color:black;">仙台駅</span></td>
                <td><span style="color:black;">福島駅</span>, <span style="color:black;">新白河駅</span></td>
            </tr>
            <tr>
                <td>JR西日本</td>
                ...
                <span style="color:black;">姫路駅</span>
                </td>
            </tr>
             <tr>
                <td>JR西日本中国地方</td>
            ...
            <!--<tr>
                <td style="background-color: gray;">JR西日本LCD</td>
                <td style="background-color: gray;"><button type="button" onclick="location.href='./index4_T.php'">移動</button></td>
                <td style="background-color: gray;"><span style="color:black;">天王寺駅</span></td>
            ...
            <tr>
                ...
                <td><span style="color:black;">品川駅</span>, <span style="color:black;">上野駅</span></td>
            </tr>
            <tr>
                <td>JR東日本千葉駅</td>
