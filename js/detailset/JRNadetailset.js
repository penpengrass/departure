...
let Cesubrapid = [['名古屋', '金山', '共和', '大府', '刈谷', '安城', '岡崎から各駅', '豊橋'], ['名古屋', '金山', '共和', '大府', '大府から各駅', '武豊']];
...
var JRCeNobj = {//色は文字
    ...
    Typeg: { type: "普通", Bcolor: white, color: black, detail: local, }
};
var JRChNobj = {//色は文字
...
let Hida=[['名古屋','尾張一宮','岐阜','美濃太田','下呂','高山','飛騨古川','猪谷','富山']];
