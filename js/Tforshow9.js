...
function JRS_Connect(td, tr, Keyword, Connect_Station) {
    if (Des[td][tr].includes(Keyword)) {
        Des[td][tr] = Des[td][tr].replace(Keyword, "");
        if (tr == 0) {
            Detail[td][0] = Des[td][0] + "で<span class='lightgreen'>" + Connect_Station + "</span>行きに接続します";
