...
<head>
    ...
    <script type="text/javascript" src="js/detailStopData/TobuSet.js"></script>
    ...
    <script type="text/javascript" src="js/stationset11.js"></script>
</head>
...
');
    ...
    <script type="text/javascript" src="js/Tforshow11.js"></script>
