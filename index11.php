...
<head>
    ...
    <link rel="stylesheet" href="css/styleTobu.css">
    <link rel="stylesheet" href="css/banner.css">
    <?php
    $files = array();
    $files[0] = 'csv/Tobu/asakusa1.csv';
    $files[1] = 'csv/Tobu/asakusa1.csv';
    $files[2] = 'csv/Tobu/asakusa1.csv';
    $files[3] = 'csv/Tobu/hikifune1.csv';
    ...
    <!--<script type="module" src="dist/jsfileimport.js"></script>-->
    <!--<script type="module" src="dist/detailset/detailcenter.js"></script>-->
    <script type="module" src="dist/detailStopData/TobuSet.js"></script>
    <script type="module" src="dist/module/firstTableEdit.js"></script>
    <!--<script type="module" src="dist/module/timeShift.js"></script>-->
    <script type="module" src="dist/stationset11.js"></script>
</head>
...
<caption><showing><p2 id="Tstation' . $i . '"></p2><p2 id="kn' . $i . '"></p2></showing></caption>
  ...
  ');
    ...
    <tr>
      ...
      <td class="CNumber" id="TNumber' . $i . $j . '"></td>
    ...
    if ($j == 1) {
        print('
      <tr>
      <td class="CDetail" colspan="7"><p3 class="news-banner__content"><p2 id="TDetail' . $i . '1" ></p2></p3></td>
      </tr>
      ');
      }
            }
...
');
    ...
    <p id="supplement">番線や停車駅や号数は不正確</p>
    <!--ここから内部のこと-->
    ...
    <script type="module" src="dist/Tforshow11.js"></script>
    <!--<script type="module" src="dist/detailshow.js"></script>-->
