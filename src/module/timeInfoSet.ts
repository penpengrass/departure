window.next = 0;//終電の時1にする
let TaRow = 1;//TaRowは縦のセル番号-1
let Sempatsu_flag = 0;//先発が決定したら1にする
let exception = 0;
export function FShow(TT: any, TableNumber: any, funcShow: any) {
...
export function FSTShow(TT: any, STShow: any, Order: number, TableNumber: number, depnum: number) {
...
function lasttrain(TT: any, Lone: number) {
