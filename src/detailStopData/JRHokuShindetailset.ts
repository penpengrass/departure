...
export var JRWSHobj = {//色は文字
    Typea: { type: "かがやき", Bcolor: 'yellow', color: black, detail: Nkagayaki, cars: '16両編成', jiyu: '自由席1-3号車' },
    Typeb: { type: "はくたか", Bcolor: red, color: white, detail: Nhakutaka, cars: '16両編成', jiyu: '自由席1-3号車' },
    Typec: { type: "つるぎ", Bcolor: '#3050FF', color: white, detail: Ntsurugi, cars: '16両編成', jiyu: '自由席1-3号車' },
    Typed: { type: "かがやき", Bcolor: 'yellow', color: 'yellow', detail: Nkagayaki, cars: '16両編成', jiyu: '自由席1-3号車' },
    Typee: { type: "はくたか", Bcolor: 'yellow', color: red, detail: Nhakutaka, cars: '16両編成', jiyu: '自由席1-3号車' },
    Typef: { type: "あさま", Bcolor: 'yellow', color: '#3050FF', detail: Nasama, cars: '16両編成', jiyu: '自由席1-3号車' },
};
