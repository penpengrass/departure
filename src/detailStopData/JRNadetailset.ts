...
export var Nagahama = [51, 3, 7, 55, 57, 13];
...
export var Kanayama = [21, 23, 25];
export var Ena = [3, 13, 25];
export var Nagiso = [1, 7, 17, 25];
export var Agematsu = [1, 25];
export var Akashina = [1, 15, 19, 23];
export var Hijirikogen=[21];
...
var rapid = Trapid.slice();
var Jrapid = HomeOgaki.slice();
...
export var JRCeNobj = {//色は文字
    ...
    Typeb: { type: "ホームライナー", Bcolor: red, color: white, detail: Jrapid, },
