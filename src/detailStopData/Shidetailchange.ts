...
const _Number0 = trainTables[0].trains[0]?.trainNumber ?? NaN;
...
if (station == '高松駅') {
    ...
    for (var line = 0; line < iyonakayama.length; line++) {
        if (_Number0 == iyonakayama[line] || _Number1 == iyonakayama[line]) {
