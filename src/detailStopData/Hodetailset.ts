...
//詳細表示の定義
export var hayabusa=new Array(2);
export var hayate=new Array(2);
export var airport=new Array(2);
export var Spairport=new Array(2);
export var Suairport=new Array(2);
export var asahikawa=new Array(2);
export var oozora=new Array(2);
export var Tohakodate=new Array(2);
hayabusa[0]=['新函館北斗','新青森','七戸十和田','八戸','二戸','いわて沼宮内','盛岡','新花巻','北上','水沢江刺','一ノ関','くりこま高原','古川','仙台'];
hayabusa[1]=['新函館北斗','新青森','八戸','盛岡','仙台','大宮','上野','東京'];
...
export var JRHSobj = {//色は文字
    ...
    Typef: { type: "特急すずらん", color: red, detail: "", },
    Typelocal: { type: "普通", color: 'lightgreen', detail: "", }
