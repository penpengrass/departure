...
var SHrapid = new Array(2);
SHrapid[0] = ["大阪上本町", "鶴橋", "五位堂", "大和高田", "大和八木", "桜井", "榛原", "室生口大野", "赤目口", "名張", "桔梗が丘", "美旗", "伊賀神戸", "青山町",
    "榊原温泉口", "伊勢中川", "松阪", "伊勢市", "宇治山田", "五十鈴川", "朝熊", "池の浦", "鳥羽"];
SHrapid[1] = ["神戸三宮", "魚崎", "西宮", "今津", "甲子園", "武庫川", "尼崎", "西九条", "九条", "ドーム前", "桜川", "大阪難波", "日本橋", "大阪上本町", "鶴橋", "生駒", "学園前", "大和西大寺", "新大宮", "奈良"];
...
var Hilimited = [[], ['大阪難波', '大阪上本町', '鶴橋', '大和八木', '津', '名古屋'], ["大阪難波", "大阪上本町", "鶴橋", "生駒", "学園前", "大和西大寺", "奈良"]];
reverseLine(Hilimited, 1, 0);
