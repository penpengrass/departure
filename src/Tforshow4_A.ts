import { AllWordChange, AllWordReplace, allLastShow, holiday_F, JRLimitedDevide, allTwoLettersDistance } from "./module/firstDisplayEdit";
import { DesMiddle } from "./module/displayEdit4";
JRLimitedDevide(1);
JRLimitedDevide(4);
